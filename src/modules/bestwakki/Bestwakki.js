  ...
  render() {
    ...
    return (
      <div className="SearchBar" >
        <input type="text" name="queryTxt" id="queryTxt" className="inputForm" onKeyUp={e => {if (e.keyCode === 13) {this.search()}}} ref={this.queryTxt} placeholder={"'" + phTxt + "' 검색해 보기"} data-defaultvalue={phTxt} />

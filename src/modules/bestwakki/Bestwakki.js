  ...
  render() {
    ...
    return (
      <div className="SearchBar" >
        <input type="text" name="queryTxt" id="" className="inputForm" onKeyUp={e => {if (e.keyCode === 13) {this.search()}}} placeholder={"'" + phTxtList[Math.floor(Math.random() * phTxtList.length)] + "' 검색해 보기"} />

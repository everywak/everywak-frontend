  ...
  render() {
    ...
    return (
      <div className="SearchBar" >
        <input type="text" name="queryTxt" id="queryTxt" className="inputForm" onKeyUp={e => {if (e.keyCode === 13) {this.search(); this.props.onsearch();}}} ref={this.queryTxt} placeholder={"'" + phTxt + "' 검색해 보기"} />
        <Dropdown className="searchTarget" name="searchTarget" values={searchTarget} value={this.queryTargetValue} />
        <div className="btnSearch" onClick={e => {this.search(); this.props.onsearch();}}>

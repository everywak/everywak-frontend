        ...
        <header>
          ...
          <div className="infoWrapper">
            ...
            <div className="actionList">
              <BasicButton className="btnDelete" background="#DB0000">
                왁툰 삭제
              </BasicButton>
  ...
  return (
    <div className="WaktoonEditorForm">
      <div className="inputFormArea">
        <InputForm
          name="제목"
          description="웹툰 메인화면과 에피소드 리스트에 표시되는 작품의 제목입니다."
        >
          <TextInput
            name="title"
        ...
        <InputForm name="연재 상태" description="작품의 연재 상태를 설정합니다.">
          <BasicSelect
            options={[
              { name: '연재중', value: 'continuing' },
              { name: '휴재', value: 'paused' },
              { name: '완결', value: 'ended' },
            ]}
            name="serialStatus"
            value={inputValue.serialStatus}
            onChange={onChange}
          />
        </InputForm>
        <InputForm
          name="소개글"
          description="에피소드 리스트의 작품 정보에 표시되는 소개글입니다. 3줄 이내로 적는 것을 추천합니다."
        >
          <TextInput
            name="description"
        ...
        <InputForm
          name="제목 검색 키워드"
          description="작품의 최신 에피소드를 등록할 때 필요한 키워드입니다.
  예를 들어 키워드를 '만화'로 설정한 뒤 왁물원 웹툰 게시판에 작품을 올리면, 제목에 '만화'를 포함한 게시글만 해당 작품의 에피소드로 등록이 됩니다."
        >
          <TextInput
            name="parseKeyword"
            value={inputValue.parseKeyword}
            placeholder="제목 검색 키워드를 입력하세요."
            onChange={onChange}
          />
        </InputForm>
      </div>
        ...
        <div className="thumbnailWrapper">
          <BasicImage
            src={
              ...
              inputValue.thumbnails &&
              inputValue.thumbnails.replace('100_100', '200_200')
            }
            alt="표지 이미지"
            noReferrer
          />

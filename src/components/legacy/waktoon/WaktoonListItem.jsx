...
function WaktoonListItem(props) {
  ...
  return (
    <li className={cx('WaktoonListItem')}>
      <Link
        to={(type == 'waktoon' ? '/waktoon/' : '/waktoon/episode/') + toonId}
        ...
        <div className="infoArea">
          <div className="descArea">
            <div className="titleWrapper">
              {Date.now() / 1000 - 3 * SECONDS_OF_DAY <
                (type === 'waktoon' ? updatedDatetime : createdDatetime) && (
                <div className="icon newIcon">N</div>
              )}
          ...
          <div className="tagArea">
            ...
            <div className="popularityArea">
              <div className="popularity view">
                ...
                <span>{viewCount > 9999 ? `${parseInt(viewCount / 1000) / 10}만` : viewCount}</span>
              </div>
              <div className="popularity up">
                <FavoriteRoundedIcon />
                <span>{upCount}</span>
              </div>
            </div>
...
function BestTag() {
  return <li className="tag BestTag">베스트</li>;
}
function WakforestTag() {
  return <li className="tag WakforestTag">왁숲</li>;
}
